...
export const config = {
  ...
  lumperMaxAmount: parseInt(process.env.LUMPER_MAX_AMOUNT || '1000', 10),
  repairMaxAmount: parseInt(process.env.REPAIR_MAX_AMOUNT || '3000', 10),
  dailyTotalLimit: parseInt(process.env.DAILY_TOTAL_LIMIT || '5000', 10),
